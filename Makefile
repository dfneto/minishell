...
# Source files
SRC = main.c init_minishell.c process_quotes.c lexical_analysis.c lexical_analysis_create_tokens_utils_token.c printers.c lexical_analysis_create_tokens.c expansion.c expansion_utils.c
